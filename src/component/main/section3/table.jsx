...
const Table = ({ title, skills }) => {
  return (
    <div className="data border-2 border-white w-full max-w-sm p-4 sm:p-6 flex flex-col min-h-88">
      ...
      >
        <div className="w-full text-center border-t border-white pt-4">
          <div className="skillslist flex flex-wrap justify-center gap-2">
